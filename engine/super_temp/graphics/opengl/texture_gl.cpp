...
namespace awesome
{
	...
	TextureGL::TextureGL(const unsigned char* const t_data, const uint t_width, const uint t_height,
		const uint t_components, const Options& t_options /* = Options */)
		: Texture(t_data, t_width, t_height, t_components, t_options)
	{
	...
	void TextureGL::bind(const uint t_slot)
	{
