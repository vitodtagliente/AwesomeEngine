...
const meta_t& PlayerState::getTypeMeta() const { return __PlayerStateType::type().meta; }
const std::string& PlayerState::getTypeName() const { return __PlayerStateType::type().name; }
