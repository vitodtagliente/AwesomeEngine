...
const meta_t& SpriteAnimationFrame::getTypeMeta() const { return SpriteAnimationFrameType::type().meta; }
const std::string& SpriteAnimationFrame::getTypeName() const { return SpriteAnimationFrameType::type().name; }
...
std::size_t SpriteAnimationFrame::getTypeSize() const { return SpriteAnimationFrameType::type().size; }
...
const meta_t& SpriteAnimationData::getTypeMeta() const { return SpriteAnimationDataType::type().meta; }
const std::string& SpriteAnimationData::getTypeName() const { return SpriteAnimationDataType::type().name; }
...
std::size_t SpriteAnimationData::getTypeSize() const { return SpriteAnimationDataType::type().size; }

const TypeDefinition& SpriteAnimationDataType::type()
{
