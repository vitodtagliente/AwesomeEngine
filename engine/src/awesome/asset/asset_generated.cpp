...
void Asset::from_string(const std::string& str) { reflect::Type<Asset>::from_string(str, *this); }
void Asset::from_json(const std::string& json) { reflect::Type<Asset>::from_json(json, *this); }
