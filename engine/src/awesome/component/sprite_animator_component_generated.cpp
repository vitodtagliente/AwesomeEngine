...
const meta_t& SpriteAnimatorComponent::getTypeMeta() const { return __SpriteAnimatorComponentType::type().meta; }
const std::string& SpriteAnimatorComponent::getTypeName() const { return __SpriteAnimatorComponentType::type().name; }
