...
fields_t ApplicationSettingsType::fields(const ApplicationSettings* const pointer)
{
    ...
    fields_t fields;
    fields.insert(std::make_pair<std::string, FieldDescriptor>("fps", FieldDescriptor("fps", FieldDescriptor::Type::T_enum, {}, "FpsMode", origin + offsetof(ApplicationSettings, fps))));
    fields.insert(std::make_pair<std::string, FieldDescriptor>("mode", FieldDescriptor("mode", FieldDescriptor::Type::T_enum, {}, "ApplicationMode", origin + offsetof(ApplicationSettings, mode))));
