...
const properties_t SceneData::getTypeProperties() const {
    member_address_t origin = reinterpret_cast<member_address_t>(this);
    properties_t properties;
    properties.insert(std::make_pair<std::string, Property>("entities", Property("entities", Property::TypeDescriptor("json::value", Property::Type::T_unknown, Property::DecoratorType::D_normalized, {}), sizeof(json::value), origin + offsetof(SceneData, entities), {
    })));
