...
const meta_t& GizmosRendererComponent::getTypeMeta() const { return __GizmosRendererComponentType::type().meta; }
const std::string& GizmosRendererComponent::getTypeName() const { return __GizmosRendererComponentType::type().name; }
