...
const meta_t& Collider2dComponent::getTypeMeta() const { return __Collider2dComponentType::type().meta; }
const std::string& Collider2dComponent::getTypeName() const { return __Collider2dComponentType::type().name; }
