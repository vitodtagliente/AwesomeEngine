...
const meta_t& CameraController2dComponent::getTypeMeta() const { return __CameraController2dComponentType::type().meta; }
const std::string& CameraController2dComponent::getTypeName() const { return __CameraController2dComponentType::type().name; }
