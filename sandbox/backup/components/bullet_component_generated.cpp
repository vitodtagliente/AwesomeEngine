...
const meta_t& BulletComponent::getTypeMeta() const { return __BulletComponentType::type().meta; }
const std::string& BulletComponent::getTypeName() const { return __BulletComponentType::type().name; }
