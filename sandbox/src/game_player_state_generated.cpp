...
const meta_t& GamePlayerState::getTypeMeta() const { return GamePlayerStateType::type().meta; }
const std::string& GamePlayerState::getTypeName() const { return GamePlayerStateType::type().name; }
...
std::size_t GamePlayerState::getTypeSize() const { return GamePlayerStateType::type().size; }

const TypeDefinition& GamePlayerStateType::type()
{
