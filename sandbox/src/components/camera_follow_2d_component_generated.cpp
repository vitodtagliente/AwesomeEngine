...
const meta_t& CameraFollow2dComponent::getTypeMeta() const { return __CameraFollow2dComponentType::type().meta; }
const std::string& CameraFollow2dComponent::getTypeName() const { return __CameraFollow2dComponentType::type().name; }
