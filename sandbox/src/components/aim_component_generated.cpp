...
const meta_t& AimComponent::getTypeMeta() const { return AimComponentType::type().meta; }
const std::string& AimComponent::getTypeName() const { return AimComponentType::type().name; }
...
std::size_t AimComponent::getTypeSize() const { return AimComponentType::type().size; }
